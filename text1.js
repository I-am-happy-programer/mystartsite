...
var n=0
var color_text=""
message=document.getElementById("text1").innerHTML;
if (document.all||document.getElementById){
    color_text='<div align="center"><font color="'+base_color+'" size="4">';
    for (m=0; m<message.length; m++) color_text+='<span id="neonlight1'+m+'">'+message.charAt(m)+'</span>'
    color_text+='</font></div>'
...
function crossref(number){
    var crossobj=document.all? eval("document.all.neonlight1"+number) :
    document.getElementById("neonlight1"+number)
    return crossobj
}
